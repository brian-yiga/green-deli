        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="grid grid-cols-2 gap-4 mb-5">
            <a
              ...
              className="bg-[#A0F69B] p-6 rounded-[2rem] flex flex-col items-center justify-center text-center cursor-pointer hover:opacity-90 transition-opacity shadow-sm"
            >
              <img
          ...
          <div className="bg-deli-charcoal rounded-[2rem] overflow-hidden relative aspect-square lg:aspect-auto lg:flex-1">
            ...
            <div className="relative z-10 mt-auto p-8 bg-deli-cream m-4 rounded-2xl">
              ...
              <p className="font-sans text-[11px] text-deli-charcoal/60 leading-relaxed uppercase tracking-wider mb-4">
                Plot 42, Artisan Valley, Industrial Area
                <br />
                Kampala, Uganda
              </p>
              <a
                href="#"
                className="font-sans text-[10px] font-bold text-deli-red uppercase tracking-widest flex items-center gap-2"
              >

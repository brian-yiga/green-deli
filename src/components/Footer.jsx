      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1">
            <div className="mb-5">
              <img
                src="/assets/full-green-deli-logo.webp"
                alt="Green Deli Logo"
                className="h-36 w-auto object-contain"
              />
            </div>
            <p className="font-sans text-sm leading-relaxed opacity-70 tracking-wide uppercase">
              Uganda's finest spice apothecary. Sustainably sourced, artisanal
              quality, and biologically potent botanicals from the heart of the
              pearl.
            </p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-deli-cream/10 pt-2 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-end gap-1">
            <span className="font-sans text-[8px] uppercase tracking-[0.3em] opacity-30">
              Development & Digital
            </span>
            <p className="font-sans text-[10px] uppercase tracking-[0.2em] font-bold opacity-60">
              Designed & Built by{" "}
              <span className="text-deli-red font-bold">Ivory Media House</span>
            </p>
          </div>
        </div>
      </div>
